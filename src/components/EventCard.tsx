...
function EventCard(props: EventProps) {
  ...
  return (
    <>
      <article
        className="mx-auto max-w-sm shadow-xl bg-cover bg-center min-h-[500px] transform duration-500 hover:-translate-y-2 cursor-pointer group min-w-[500px]"
        style={{
      ...
      >
        <div className="bg-black  bg-opacity-20 min-h- px-10 flex flex-wrap flex-col pt-60 hover:bg-opacity-75 transform duration-300">
          ...
          <button className="m-10 opacity-0 text-black bg-yellow-500 px-4 py-2 mt-4 rounded group-hover:opacity-100 transform duration-500">
            Register Now
          </button>
        </div>
      </article>
